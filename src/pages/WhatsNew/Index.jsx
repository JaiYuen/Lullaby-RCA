        ...
        class WhatsNew extends Component {
            render() {
                return (
                   ...
                   <div className={styles.red}>这是首页，路径为src/pages/WhatsNew/Index.jsx</div>
                   <div className={styles.blue}>下面是状态管理器<strong>Mobx</strong>中的数据</div>
                   <div>{this.props.userStore.counts}</div>
                   <Button type="primary" onClick={this.clickNet}>网络请求相关功能</Button>
                   </div>
                );
            }
            clickNet=()=>{
